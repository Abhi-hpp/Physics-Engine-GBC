...
int main()
{
	...
	world.getSystemManager().addSystem<PlaneNormalSystem>();
	...
	while (!glfwWindowShouldClose(world.data.renderUtil->window->glfwWindow))
	{
		...
		world.getSystemManager().getSystem<PlaneNormalSystem>().Update(deltaTime);
...
void MakeARopeBridge(ECSWorld & world)
{
	...
	ePivot1.addComponent<TransformComponent>(Vector3(3, 15, 5));
	...
	ePivot2.addComponent<TransformComponent>(Vector3(3, 15, -5));
	...
	ePivot3.addComponent<TransformComponent>(Vector3(3 + 10, 15, 5));
	...
	ePivot4.addComponent<TransformComponent>(Vector3(3 + 10, 15, -5));
	...
	ePivot5.addComponent<TransformComponent>(Vector3(3 - 10, 15, 5));
	...
	ePivot6.addComponent<TransformComponent>(Vector3(3 - 10, 15, -5));
	...
	auto sphere = world.createEntity();
	sphere.addComponent<TransformComponent>(Vector3(0, 10, -2));
	...
	plane1.addComponent<PlaneNormalComponent>(e1, e2, e3, sphere);

	auto plane2 = world.createEntity();
	plane2.addComponent<PlaneNormalComponent>(e3, e4, e2, sphere);

	auto plane3 = world.createEntity();
	plane3.addComponent<PlaneNormalComponent>(e1, e2, e5, sphere);

	auto plane4 = world.createEntity();
	plane4.addComponent<PlaneNormalComponent>(e5, e6, e2, sphere);
