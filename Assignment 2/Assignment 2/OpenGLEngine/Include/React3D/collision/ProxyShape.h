...
class ProxyShape {
    ...
    public:
		...
		/// Return the collision shape Public
		const CollisionShape* getCollisionShapePublic() const;
...
* @return Pointer to the internal collision shape
*/
inline const CollisionShape* ProxyShape::getCollisionShapePublic() const {
	return mCollisionShape;
}
