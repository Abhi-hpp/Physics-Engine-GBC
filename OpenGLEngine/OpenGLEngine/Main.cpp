...
void MakeRopeBridgeAssigment(ECSWorld& world);
void InputSpawnSphere(ECSWorld& world);

void createRandomSphere(Reality::ECSWorld& world);
...
int main()
{
	...
	world.getSystemManager().addSystem<TriangleBodySystem>();
	...
	while (!glfwWindowShouldClose(world.data.renderUtil->window->glfwWindow))
	{
		...
		world.getSystemManager().getSystem<TriangleBodySystem>().Update(deltaTime);
...
void createRandomSphere(Reality::ECSWorld& world)
{
	...
	newSphere.addComponent<TransformComponent>(Vector3(RANDOM_FLOAT(-18, 18), RANDOM_FLOAT(0, 10), RANDOM_FLOAT(-4, 4)));
...
void MakeRopeBridgeAssigment(ECSWorld & world)
{
	...
	// Triangle bodies
	auto triangleBody1 = world.createEntity();
	triangleBody1.addComponent<TriangleBodyComponent>(e2, e1, e3);

	auto triangleBody2 = world.createEntity();
	triangleBody2.addComponent<TriangleBodyComponent>(e3, e4, e2);

	auto triangleBody3 = world.createEntity();
	triangleBody3.addComponent<TriangleBodyComponent>(e6, e5, e1);

	auto triangleBody4 = world.createEntity();
	triangleBody4.addComponent<TriangleBodyComponent>(e1, e2, e6);

	auto triangleBody5 = world.createEntity();
	triangleBody5.addComponent<TriangleBodyComponent>(e4, e3, e7);

	auto triangleBody6 = world.createEntity();
	triangleBody6.addComponent<TriangleBodyComponent>(e7, e8, e4);

	auto triangleBody7 = world.createEntity();
	triangleBody7.addComponent<TriangleBodyComponent>(e10, e9, e5);

	auto triangleBody8 = world.createEntity();
	triangleBody8.addComponent<TriangleBodyComponent>(e5, e6, e10);
