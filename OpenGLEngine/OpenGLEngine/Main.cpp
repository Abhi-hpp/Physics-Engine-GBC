...
void LoadModels(ECSWorld& world)
{
	...
	ModelData("Resources/Models/supermarine-spitfire/spitfire.fbx",
		{{"spitfire_d.png"}}),
	ModelData("Resources/Models/RAT/boat.fbx",
		{{"RatBoat.png"}}),
	ModelData("Resources/Models/water/water.fbx",
		{{"water Base Color.png"}})
		});
...
void MakeABoatSimulator(ECSWorld& world)
{
	...
	//boat.addComponent<TransformComponentV2>();
	...
	boat.addComponent<ModelComponent>("Resources/Models/RAT/boat.fbx", Vector3(-90, 0, 0), Vector3(0, 0, 0));

	boat.addComponent<GravityForceComponent>(1.0f);

	//boat.addComponent<ParticleComponent>();
	/*
	auto frontBuoy = world.createEntity();
	auto backBuoy = world.createEntity();

	frontBuoy.addComponent<BuoyancyCenterComponent>(Vector3(0.0f, 3.0f, 10.0f), 5.0f, 1.0f);
	frontBuoy.addComponent<RigidbodyComponent>();
	frontBuoy.addComponent<ForceAndTorqueAccumulatorComponent>();
	frontBuoy.addComponent<GravityForceComponent>(5);

	backBuoy.addComponent<BuoyancyCenterComponent>(Vector3(0.0f, 0.0f, -10.0f), 5.0f, 1.0f);
	backBuoy.addComponent<RigidbodyComponent>();
	backBuoy.addComponent<ForceAndTorqueAccumulatorComponent>();
	backBuoy.addComponent<GravityForceComponent>(5);

	auto frontRod = world.createEntity();
	frontRod.addComponent<RodComponent>(frontBuoy, boat, 10);

	auto backRod = world.createEntity();
	backRod.addComponent<RodComponent>(backBuoy, boat, 10);
	*/
