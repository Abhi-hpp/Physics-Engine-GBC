...
// ASSIGNMENT 3 by Amer Ali Mohammed (ID: 101206769), Talhah Ramadan Salick (ID: 101214166) and Jeremy Evans (ID: 101221919)
...
void LoadModels(ECSWorld& world)
{
	world.data.assetLoader->StartModelLoading({
		...
		ModelData("Resources/Models/supermarine-spitfire/spitfire.fbx",
			{{"spitfire_d.png"}}),
		ModelData("Resources/Models/Boat/boat.obj", {{"wood1.jpg"}})
		});
}
...
void MakeABoatSImulator(ECSWorld& world)
{
	...
	buoyancyRear.addComponent<BuoyancyComponent>(boat, 4.f, 2.f, Vector3(2, 0, 0));
	...
	leftRotating.addComponent<AeroControlComponent>(Vector3(0, 5.f, 0),	Vector3(0, -5.f, 0), leftRotatingPositiveKeys, leftRotatingNegetiveKeys);
	...
	rightRotating.addComponent<AeroControlComponent>(Vector3(0, 5.f, 0), Vector3(0, -5.f, 0), rightRotatingPositiveKeys, rightRotatingNegetiveKeys);
