...
void MakeANBody(ECSWorld& world);
void MakeABouyancyVolume(ECSWorld& world);
...
void MakeABouyancyVolume(ECSWorld& world)
{
	auto buoyant = world.createEntity();

	buoyant.addComponent<TransformComponent>(Vector3(0, 10, 0), Vector3(5, 5, 5), Vector3(0, 0, 0));
	buoyant.addComponent<ParticleComponent>(Vector3(0,  10,  0));
...
void MakeANBody(ECSWorld& world)
{
	...
	Nbody.addComponent<TransformComponent>(Vector3(RANDOM_FLOAT(-50, 50), RANDOM_FLOAT(-50, 50), RANDOM_FLOAT(-50, 50)));
	Nbody.addComponent<ForceAccumulatorComponent>();
	Nbody.addComponent<ParticleComponent>(Vector3(RANDOM_FLOAT(-1, 1), RANDOM_FLOAT(-1, 1), RANDOM_FLOAT(-1, 1)), Color::Orange);
