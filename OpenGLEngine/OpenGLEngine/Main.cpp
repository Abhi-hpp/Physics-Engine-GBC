...
void Boat(ECSWorld & world)
{
	...
	boat.addComponent<TransformComponentV2>(Vector3(0, 0, 0), Vector3(0.13f, 0.13f, 0.13f), Vector3(0, 0, 0));
	boat.addComponent<ModelComponent>("Resources/Models/Boat.fbx", Vector3(-90, 90, 0));
	boat.addComponent<RigidbodyComponent>();
	boat.addComponent<ForceAndTorqueAccumulatorComponent>(7.0f, 1.0f);
	...
	frontLeft.addComponent<BuoyancyComponent>(boat, Vector3(-140.0f, -4, 140.0f), PositiveKeys);
	frontRight.addComponent<BuoyancyComponent>(boat, Vector3(140.0f, -4, 140.0f), NegativeKeys);
	backLeft.addComponent<BuoyancyComponent>(boat, Vector3(-140.0f, 4, -140.0f), PositiveKeys);
	backRight.addComponent<BuoyancyComponent>(boat, Vector3(140.0f, 4, -140.0f), NegativeKeys);
