...
int main()
{
	...
	ECSEntity sphere = world.createEntity();
	sphere.addComponent<TransformComponent>(Vector3(-3, 6, 4));
	sphere.addComponent<ParticleComponent>(Vector3(0, 0, 0));
	sphere.addComponent<ForceAccumulatorComponent>(30);
	sphere.addComponent<GravityForceComponent>();
	sphere.addComponent<DragForceComponent>(0.2, 0.2);
	...
	while (!glfwWindowShouldClose(world.data.renderUtil->window->glfwWindow))
	{
		...
		if (glfwGetKey(world.data.renderUtil->window->glfwWindow, GLFW_KEY_E) == GLFW_PRESS && pressedE == false)
		{
			sphere.getComponent<TransformComponent>().position = Vector3(-3, 6, 4);
			sphere.getComponent<ParticleComponent>().velocity = Vector3(0, 0, 0);
		}
		if (glfwGetKey(world.data.renderUtil->window->glfwWindow, GLFW_KEY_E) == GLFW_RELEASE && pressedE == true)
		{
			pressedE = false;
		}
...
void MakeARopeBridge(ECSWorld & world)
{
	...
	e1.addComponent<TransformComponent>(Vector3(3, -10, 5));
	...
	e2.addComponent<TransformComponent>(Vector3(3, -10, -5));
	...
	e3.addComponent<TransformComponent>(Vector3(3 + 10, -5, 5));
	...
	e4.addComponent<TransformComponent>(Vector3(3 + 10, -5, -5));
	...
	e5.addComponent<TransformComponent>(Vector3(3 - 10, -5, 5));
	...
	e6.addComponent<TransformComponent>(Vector3(3 - 10, -5, -5));
	...
	e7.addComponent<TransformComponent>(Vector3(3 + 20, 0, 5));
	...
	e8.addComponent<TransformComponent>(Vector3(3 + 20, 0, -5));
	...
	e9.addComponent<TransformComponent>(Vector3(3 - 20, 0, 5));
	...
	e10.addComponent<TransformComponent>(Vector3(3 - 20, 0, -5));
	...
	auto triange_1 = world.createEntity();
	triange_1.addComponent<TriangleComponent>(e2, e1, e3);
	auto triange_2 = world.createEntity();
	triange_2.addComponent<TriangleComponent>(e3, e4, e2);
	auto triange_3 = world.createEntity();
	triange_3.addComponent<TriangleComponent>(e6, e5, e1);
	auto triange_4 = world.createEntity();
	triange_4.addComponent<TriangleComponent>(e1, e2, e6);
	auto triange_5 = world.createEntity();
	triange_5.addComponent<TriangleComponent>(e4, e3, e7);
	auto triange_6 = world.createEntity();
	triange_6.addComponent<TriangleComponent>(e7, e8, e4);
	auto triange_7 = world.createEntity();
	triange_7.addComponent<TriangleComponent>(e10, e9, e5);
	auto triange_8 = world.createEntity();
	triange_8.addComponent<TriangleComponent>(e5, e6, e10);
}
