...
void MakeABunchaBuouancys(ECSWorld& world);
void MakeABunchaPGravitys(ECSWorld& world);
...
int main()
{
	...
	MakeABunchaBuouancys(world);
	MakeABunchaPGravitys(world);
	...
	world.getSystemManager().addSystem<BuouancySystem>();
	world.getSystemManager().addSystem<PGravitySystem>();
	...
	while (!glfwWindowShouldClose(world.data.renderUtil->window->glfwWindow))
	{
		...
		world.data.renderUtil->DrawCube(Vector3(0,9,0), Vector3(20, 20, 20), Vector3(0,0,0), Color::Red);
		...
		world.getSystemManager().getSystem<BuouancySystem>().Update(fixedDeltaTime);
		world.getSystemManager().getSystem<PGravitySystem>().Update(fixedDeltaTime);
		...
		world.getSystemManager().getSystem<ParticleSphereSystem>().Update(fixedDeltaTime);
		// Rendering Update
...
void Make3Particles(ECSWorld & world)
{
	...
	particle3.addComponent<ParticleComponent>(Vector3(0, 100, 0));
...
void MakeABunchaSpheres(ECSWorld& world)
{
	...
	sphere.addComponent<ParticleComponent>(Vector3(0,20,0));
...
void MakeABunchaSprings(ECSWorld & world)
{
	...
	spring1.addComponent<FixedSpringComponent>(20.0f, 1.0f, particle1);*/
...
void MakeABunchaBungees(ECSWorld& world)
{
	...
	particle1.addComponent<TransformComponent>(Vector3(0, 20, -50));
	particle1.addComponent<ParticleComponent>(Vector3(0, 0, 0));
	particle1.addComponent<ForceAccumulatorComponent>(1);
	//particle1.addComponent<GravityForceComponent>();

	auto particle2 = world.createEntity();
	particle2.addComponent<TransformComponent>(Vector3(-10, 0, -50));
	particle2.addComponent<ParticleComponent>(Vector3(0, 0, 0));
	particle2.addComponent<ForceAccumulatorComponent>(1);
	//particle2.addComponent<GravityForceComponent>();
	...
	auto spring2 = world.createEntity();
	spring2.addComponent<TransformComponent>(Vector3(-10, 60, -50));
	spring2.addComponent<FixedSpringComponent>(1.0f, 0.0f, particle1);


	auto pairedSpring = world.createEntity();
	pairedSpring.addComponent<BungeeComponent>(1.0f, 5.0f, particle1, particle2);
...
void MakeABunchaPGravitys(ECSWorld& world)
{
	...
	{
		auto sphere = world.createEntity();
		sphere.addComponent<TransformComponent>(Vector3(20, 20, RANDOM_FLOAT(-20, 20)));
		sphere.addComponent<ParticleComponent>(Vector3(RANDOM_FLOAT(-10, 10), 0, RANDOM_FLOAT(-2, 2)));
		sphere.addComponent<ForceAccumulatorComponent>(RANDOM_FLOAT(1, 6));
		sphere.addComponent<GravityForceComponent>(0);
		sphere.addComponent<PGravityComponent>();
	}
}
...
void MakeABunchaBuouancys(ECSWorld& world)
{
	...
	particle1.addComponent<ParticleComponent>(Vector3(0, 0, 0));
	particle1.addComponent<ForceAccumulatorComponent>(1);
	particle1.addComponent<DragForceComponent>(1, 0);
	particle1.addComponent<BuoyancyComponent>(10, 0.005, 30, 1000.0f);

	auto particle2 = world.createEntity();
	particle2.addComponent<TransformComponent>(Vector3(3, 0, 6));
	particle2.addComponent<ParticleComponent>(Vector3(0, 0, 0));
	particle2.addComponent<ForceAccumulatorComponent>(1);
	particle2.addComponent<DragForceComponent>(1, 0);
	particle2.addComponent<BuoyancyComponent>(10, 0.0005, 30, 1000.0f);
}
