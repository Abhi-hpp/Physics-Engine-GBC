...
void MakeABungeeCord(ECSWorld & world)
{
	auto bungeeCord = world.createEntity();
	bungeeCord.addComponent<TransformComponent>(Vector3(1.0f, 50.0f, 1.0f), Vector3(10.0f, 10.0f, 10.0f));
	bungeeCord.addComponent<BungeeChordComponent>(Vector3(10, -10, 10), 100.0f, 5.0f);
}
