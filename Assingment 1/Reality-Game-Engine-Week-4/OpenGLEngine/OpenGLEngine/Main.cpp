...
void MakeABungee(ECSWorld& world);
...
void MakeABungee(ECSWorld& world)
{
	...
	auto pairedSpring = world.createEntity();
	pairedSpring.addComponent<BungeeComponent>(20.0f, 20.0f, particle1, particle2);
}
...
void MakeABuoyancy(ECSWorld& world)
{
	...
	auto buoyancySpring = world.createEntity();
	buoyancySpring.addComponent<BuoyancyComponent>(2.0f, 0.1f, 5.0f, 1000.0f, particle1);
